...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, getCookie, setCookie, sanitizeStatusCode, removeResponseHeader, getQuery as getQuery$1, readBody, getRouterParam, setHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, withoutTrailingSlash, withTrailingSlash, decodePath, encodePath } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/source-map/source-map.js';
import { createRouterMatcher } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/vue-router/vue-router.node.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/.nuxt/nuxt-icon-server-bundle.mjs';
import localAdapter from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/yvan/Dev/web/work3/yvan/frontend/server/assets"}];
...
const _47home_47yvan_47Dev_47web_47work3_47yvan_47frontend_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/yvan/Dev/web/work3/yvan/frontend","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/yvan/Dev/web/work3/yvan/frontend/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('cache:nuxt:payload', _47home_47yvan_47Dev_47web_47work3_47yvan_47frontend_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/home/yvan/Dev/web/work3/yvan/frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/home/yvan/Dev/web/work3/yvan/frontend/.nuxt/cache/nuxt/payload"}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/yvan/Dev/web/work3/yvan/frontend/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/yvan/Dev/web/work3/yvan/frontend/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/yvan/Dev/web/work3/yvan/frontend/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/journal/sql_dump.txt": {
        "prerender": true
      },
      "/_fonts/**": {
        "headers": {
      ...
      "/__nuxt_content/journal/sql_dump.txt/_payload.json": {
        "prerender": true
      }
    }
  },
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/home/yvan/Dev/web/work3/yvan/frontend/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _NlHdCSs5K9r9_1nyW_YHplJwozF_kOeA9LhXhGdJro = (function(nitro) {
...
var nav_about$1 = "À propos";
var nav_discovery$1 = "Découvrir";
var nav_blog$1 = "Journal";
var jukebox$1 = {
	play: "Marche",
	stop: "Arrêt"
};
...
var about$1 = {
	title: "Consultant infrastructure",
	pitch: "Ingénieur en informatique spécialisé dans la gestion et le déploiement d'infrastructures. Je développe des outils d'automatisation pour la gestion d'infrastructures.",
	sections: {
		profile: "à propos de moi",
		exp: "Expériences professionnelles",
		edu: "Parcours académique",
		skills: "Compétences",
		certs: "Certifications"
	},
	education: [
		{
			degree: "Diplôme d’Ingénieur en Informatique (Filière F5)",
			school: "ISIMA - Institut Supérieur d'Informatique, de Modélisation et de leurs Applications",
			date: "2022 — 2025",
			details: "Spécialisation Réseaux et Sécurité Informatique. Label CyberEdu. Expertise en administration systèmes, réseaux et cyber-défense."
		},
		{
			degree: "Master Management et Administration des Entreprises (MAE)",
			school: "IAE Clermont Auvergne - School of Management",
			date: "2024 — 2025",
			details: "Double diplôme effectué durant la dernière année d'école d'ingénieur. Focus sur la gestion de projet, finance et stratégie d'entreprise."
		},
		{
			degree: "Semestre d'échange Erasmus+ (Pologne)",
			school: "Poznań University of Technology",
			date: "2024",
			details: "Focus sur la cryptographie, la sécurité réseau et l'informatique décisionnelle en environnement international."
		},
		{
			degree: "Classes Préparatoires aux Grandes Écoles (CPGE) - PTSI/PT",
			school: "Lycée Étienne Mimard (St-Étienne)",
			date: "2020 — 2022",
			details: "Mathématiques, physique et sciences de l'ingénieur."
		},
		{
			degree: "Baccalauréat Scientifique (S-SI) - Mention Très Bien",
			school: "Lycée Galilée (Vienne, 38)",
			date: "2020",
			details: "Spécialité Sciences de l'Ingénieur."
		}
	],
	experiences: [
		{
			title: "Ingénieur Infrastructure IT",
			company: "Abicom - Groupe OCI",
			date: "2025 — Présent",
			icon: "streamline-plump:sign-at-solid",
			description: "Développement d'outils d'automatisation pour le déploiement d'infrastructures à grande échelle (1000+ hôtes ESXi) et support technique aux équipes opérationnelles internationales.",
			highlights: [
				"Réduction de 75% du temps de déploiement VMware via le développement de frameworks PowerCLI / PowerShell.",
				"Automatisation complète de clusters Hyper-V (Réseau, Stockage CSV, Durcissement de sécurité).",
				"Sécurité-as-Code : Automatisation des firewalls Palo Alto via API REST pour garantir la fiabilité des règles de sécurité.",
				"Conception d'un outil de documentation automatique, économisant une journée de travail manuel par déploiement.",
				"Développement de scripts pour valider la Haute Disponibilité (HA) via des simulations de pannes.",
				"Gestion des cycles de maintenance (Patching) sur des stacks VMware/Datacore/Veeam avec sécurisation des liens de stockage."
			]
		}
	],
	skills: [
		{
			...
			items: [
				"VMware vSphere 8 (Déploiement en entreprise)",
				"vCenter Server",
				"PowerCLI",
				"Hyper-V (failover clustering)",
				"Docker",
				"Kubernetes (Bases K3s)",
				"Azure (Bases théoriques)"
			]
		},
		{
			label: "Automatisation & IaC",
			items: [
				"PowerShell (Avancé)",
				"Automatisation pilotée par configuration (YAML/JSON)",
				"Python",
				"Git",
				"API Redfish",
		...
		},
		{
			...
			items: [
				...
				"DNS / DHCP",
				"VLANs",
				"Firewalls Palo Alto (API & gestion de règles)",
				"Cybersécurité (Analyse de menaces, CTF)"
			]
		},
		{
			label: "Supervision & Sauvegarde",
			items: [
				"Veeam (Dépannage & support mise à jour)",
				"Centreon (Utilisation basique)",
				"Beszel (Homelab)",
				"Zabbix (Exploration)"
			]
		},
		...
		},
		{
			...
			items: [
				...
				"Alignement des besoins & cadrage"
			]
		}
	],
	certifications: [
	...
	list: [
		{
			name: "Deneb Labs",
			category: "followed",
			url: "https://deneb-labs.com/",
			desc: "Solutions innovantes pour analyser les données grâce à PowerBI."
		},
		{
			name: "Custotracks",
			category: "followed",
			url: "https://custotrack.com/",
			desc: "Outil ERP et CRM nouvelle génération."
		},
		{
			name: "Awesome Selfhosted",
			category: "tools",
			url: "https://github.com/awesome-selfhosted/awesome-selfhosted",
			desc: "Une liste d'outils self-hosted à héberger sur son homelab."
		}
	]
};
...
var nav_about = "About";
var nav_discovery = "Discovery";
var nav_blog = "Journal";
var jukebox = {
	play: "On air",
	stop: "Stopped"
};
...
var about = {
	...
	pitch: "Infrastructure Engineer expert in large-scale deployment and administration. Focused on building custom automation tooling for infrastructure management",
	sections: {
		profile: "About Me",
	...
	education: [
		{
			...
			school: "ISIMA - Graduate School of Computer Science & Engineering",
			date: "2022 — 2025",
			details: "Major in Networks and Security. CyberEdu Label. Core expertise in systems administration, network infrastructure, and cyber-defense."
		},
		{
			degree: "Master of Business Administration (MBA / MAE)",
			school: "IAE Clermont Auvergne - School of Management",
			date: "2024 — 2025",
			details: "Double degree completed alongside Engineering school. Focused on project management and business strategy."
		},
		{
			degree: "Erasmus+ Exchange Program (Poland)",
			school: "Poznań University of Technology",
			date: "2024",
			details: "International academic semester focused on cryptography, network security, and business intelligence."
		},
		{
			degree: "Intensive Post-Secondary Foundation in Engineering (CPGE)",
			school: "Lycée Étienne Mimard (St-Étienne)",
			date: "2020 — 2022",
			details: "Two-year highly selective program in advanced mathematics, physics, and engineering sciences."
		},
		{
			degree: "French Baccalaureate in Science (S-SI) – High Honors",
			school: "Lycée Galilée (Vienne, France)",
			date: "2020",
			details: "Major in Engineering Sciences. Equivalent to A-Levels / High School Diploma with focus on advanced calculus and mechanics."
		}
	],
	experiences: [
		{
			...
			date: "2025 — Present",
			icon: "streamline-plump:sign-at-solid",
			description: "Engineered infrastructure automation tools for large-scale deployments (1,000+ ESXi hosts) and provided technical enablement for international operational teams.",
			highlights: [
				"Reduced manual deployment effort by 75% through PowerCLI & PowerShell automation of VMware vCenter environments.",
				"End-to-end automation of Hyper-V Failover Clusters, including networking, storage (CSV), and security hardening.",
				"Security-as-Code: Automated Palo Alto firewall configurations (Geo-blocking, rulebases) via PAN-OS REST API.",
				"Engineered an automated documentation tool for cluster deployments, saving 1 full day of manual reporting per project.",
				"Developed fault-tolerance testing suites to validate High-Availability (HA) by simulating random outages and verifying VM resilience.",
				"Managed patching cycles for VMware/Datacore/Veeam stacks, including pre-update health-check scripts for storage links."
			]
		}
	],
	skills: [
		{
			...
			items: [
				"VMware vSphere 8 (Enterprise deployment)",
				"vCenter",
				"PowerCLI",
				"Hyper-V (failover clustering)",
				"Docker",
				"Kubernetes (K3s fundamentals)",
				"Azure (foundational coursework)"
			]
		},
		{
		...
		},
		{
			...
			items: [
				...
				"DHCP",
				"VLANs",
				"Palo Alto Firewalls (API/rulebase exposure)",
				"Cybersecurity fundamentals (threat analysis, CTF experience)"
			]
		},
		{
		...
		},
		{
			...
			items: [
				"Veeam (troubleshooting/patching support)",
				"Centreon (basic exposure)",
				"Beszel (homelab)",
				"Zabbix (exploratory)"
			]
		},
	...
	list: [
		{
			...
			category: "followed",
			url: "https://deneb-labs.com/",
			desc: "Innovative solutions to analyse data thanks to PowerBI."
		},
		{
			name: "Custotracks",
			category: "followed",
			url: "https://custotrack.com/",
			desc: "Next generation ERP and CRM tooling."
		},
		{
			name: "Awesome Selfhosted",
			category: "tools",
			url: "https://github.com/awesome-selfhosted/awesome-selfhosted",
			desc: "The definitive list of self-hosted software. A must-have for any homelab enthusiast."
		}
	]
};
...
const localeLoaders = {
  fr: [
    {
      key: "locale_fr_46json_925f8cf8",
      load: () => Promise.resolve(locale_fr_46json_925f8cf8),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_778f4dd5",
      load: () => Promise.resolve(locale_en_46json_778f4dd5),
      cache: true
    }
  ]
};
...
const _0k_gJarwQ_JK1JsFNMVXLxD71OLRF1jBEEMU8cZ9A = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const rootDir = "/home/yvan/Dev/web/work3/yvan/frontend";
...
const _Y_iVM7I6Ul3miYhsV8i5to64vPilbEDT91yRZAmxog = (nitroApp) => {
...
const _8Dlm0rBzeRLOXSekV3hRqG5goKBChvuKzjprrq15M = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _NlHdCSs5K9r9_1nyW_YHplJwozF_kOeA9LhXhGdJro,
_0k_gJarwQ_JK1JsFNMVXLxD71OLRF1jBEEMU8cZ9A,
_Y_iVM7I6Ul3miYhsV8i5to64vPilbEDT91yRZAmxog,
_8Dlm0rBzeRLOXSekV3hRqG5goKBChvuKzjprrq15M,
...
const _WimqBK = eventHandler((event) => {
...
const _ATEiDE = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _r5kv7Q = _messagesHandler ;

const _3E6fzB = eventHandler(async (event) => {
  ...
  return await import('file:///home/yvan/Dev/web/work3/yvan/frontend/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _HMq1JH = eventHandler(async (event) => {
...
const _lazy_CI7h2V = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _WimqBK, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_CI7h2V, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _ATEiDE, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _r5kv7Q, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/journal/sql_dump.txt', handler: _3E6fzB, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _3E6fzB, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/journal/query', handler: _HMq1JH, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _HMq1JH, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_CI7h2V, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CI7h2V, lazy: true, middleware: false, method: undefined }
];
