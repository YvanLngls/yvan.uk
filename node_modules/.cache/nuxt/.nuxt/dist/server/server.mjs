...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef as toRef$1, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineAsyncComponent, onScopeDispose, watch, computed, toValue, unref, defineComponent, useSlots, h, Fragment, createElementBlock, provide, cloneVNode, onServerPrefetch, nextTick, customRef, resolveComponent, createVNode, Text, toRefs, readonly, shallowReadonly, renderSlot, toHandlerKey, camelize as camelize$1, Comment, mergeProps, openBlock, createBlock, withCtx, Teleport, createCommentVNode, watchEffect, markRaw, createTextVNode, toDisplayString as toDisplayString$1, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, resolveDynamicComponent, useSSRContext, useModel, mergeModels, renderList, useTemplateRef, useId, Suspense, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import defu$1, { defu, defuFn, createDefu } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parsePath, parseQuery, withTrailingSlash, withoutTrailingSlash, withLeadingSlash } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/@unhead/vue/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon } from "@iconify/vue";
import { klona } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/klona/dist/index.mjs";
...
import { debounce } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/perfect-debounce/dist/index.mjs";
import { hash, isEqual } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/ohash/dist/index.mjs";
import { isPlainObject as isPlainObject$1 } from "@vue/shared";
import { parse as parse$1 } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import { getRequestURL as getRequestURL$1, getRequestHeader as getRequestHeader$1, getCookie as getCookie$1 } from "/home/yvan/Dev/web/work3/yvan/frontend/node_modules/h3/dist/index.mjs";
...
const _routes = [
  {
    name: "journal-slug",
    path: "/journal/:slug()",
    component: () => import("./_nuxt/_slug_-BqaewLYm.js")
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-BxHxl4AH.js")
  },
  {
    name: "discovery",
    path: "/discovery",
    component: () => import("./_nuxt/discovery-B_s024xn.js")
  },
  {
    name: "journal",
    path: "/journal",
    component: () => import("./_nuxt/index-BrbwKIF0.js")
  },
  {
    name: "macroview",
    path: "/macroview",
    component: () => import("./_nuxt/macroview-DJK4wTbk.js")
  },
  {
    name: "world-data",
    path: "/world-data",
    component: () => import("./_nuxt/world-data-BjyDVmZw.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Vq8RzbsN.js")
  }
];
...
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/A-BIFE1rN4.js").then((r) => r["default"] || r.default || r));
const LazyProseAccordion = defineAsyncComponent(() => import("./_nuxt/Accordion-CYLiGjAU.js").then((r) => r["default"] || r.default || r));
const LazyProseAccordionItem = defineAsyncComponent(() => import("./_nuxt/AccordionItem-C6LYk9Nm.js").then((r) => r["default"] || r.default || r));
const LazyProseBadge = defineAsyncComponent(() => import("./_nuxt/Badge-BlI7iD0K.js").then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/Blockquote-yQyhS6D2.js").then((r) => r["default"] || r.default || r));
const LazyProseCallout = defineAsyncComponent(() => import("./_nuxt/Callout-DImt40tK.js").then((r) => r["default"] || r.default || r));
const LazyProseCard = defineAsyncComponent(() => import("./_nuxt/Card-D1M5nG5U.js").then((r) => r["default"] || r.default || r));
const LazyProseCardGroup = defineAsyncComponent(() => import("./_nuxt/CardGroup-DWZPem5m.js").then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/Code-B_7GcEkn.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeCollapse = defineAsyncComponent(() => import("./_nuxt/CodeCollapse-B9OjrCsl.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeGroup = defineAsyncComponent(() => import("./_nuxt/CodeGroup-B_gH81I5.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeIcon = defineAsyncComponent(() => import("./_nuxt/CodeIcon-O3SIPkuH.js").then((r) => r["default"] || r.default || r));
const LazyProseCodePreview = defineAsyncComponent(() => import("./_nuxt/CodePreview-DgrHnPl9.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeTree = defineAsyncComponent(() => import("./_nuxt/CodeTree-B6HmYX6g.js").then((r) => r["default"] || r.default || r));
const LazyProseCollapsible = defineAsyncComponent(() => import("./_nuxt/Collapsible-CxmdjNnv.js").then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/Em-hHt9l7F3.js").then((r) => r["default"] || r.default || r));
const LazyProseField = defineAsyncComponent(() => import("./_nuxt/Field-D-WeIREw.js").then((r) => r["default"] || r.default || r));
const LazyProseFieldGroup = defineAsyncComponent(() => import("./_nuxt/FieldGroup-BZY8jnpe.js").then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/H1-BBnGh9Pz.js").then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/H2-Dzdv-vFf.js").then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/H3-DMGG0RjN.js").then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/H4-bDpNLN4w.js").then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/Hr-CsAH12Ee.js").then((r) => r["default"] || r.default || r));
const LazyProseIcon = defineAsyncComponent(() => import("./_nuxt/Icon-MPO_fEzd.js").then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/Img-BbSRD2nL.js").then((r) => r["default"] || r.default || r));
const LazyProseKbd = defineAsyncComponent(() => import("./_nuxt/Kbd-fmfVeYbf.js").then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/Li-CqXBtC2p.js").then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/Ol-CDtFaZ4K.js").then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/P-CVjpYwGP.js").then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import("./_nuxt/Pre-CQhk6Y4p.js").then((r) => r["default"] || r.default || r));
const LazyProsePrompt = defineAsyncComponent(() => import("./_nuxt/Prompt-B3mXIVlK.js").then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import("./_nuxt/Script-BOX32BRp.js").then((r) => r["default"] || r.default || r));
const LazyProseSteps = defineAsyncComponent(() => import("./_nuxt/Steps-8O3QbP3e.js").then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/Strong-D-TmYIzz.js").then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/Table-CMR1rp4j.js").then((r) => r["default"] || r.default || r));
const LazyProseTabs = defineAsyncComponent(() => import("./_nuxt/Tabs-Cd-UQ1MZ.js").then((r) => r["default"] || r.default || r));
const LazyProseTabsItem = defineAsyncComponent(() => import("./_nuxt/TabsItem-DzSVlU0V.js").then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/Tbody-DUHxwKrg.js").then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/Td-UG6hn2X_.js").then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/Th-kQCScXGd.js").then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/Thead-DXH2D-Kj.js").then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/Tr-C6TWIHOX.js").then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/Ul-UYA9AdhZ.js").then((r) => r["default"] || r.default || r));
const LazyProseCaution = defineAsyncComponent(() => import("./_nuxt/Caution-CNg8Svkm.js").then((r) => r["default"] || r.default || r));
const LazyProseNote = defineAsyncComponent(() => import("./_nuxt/Note-DKuy39SD.js").then((r) => r["default"] || r.default || r));
const LazyProseTip = defineAsyncComponent(() => import("./_nuxt/Tip-M5u346_I.js").then((r) => r["default"] || r.default || r));
const LazyProseWarning = defineAsyncComponent(() => import("./_nuxt/Warning-Di6tz1Zk.js").then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-B4dQMHKq.js").then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-BPqxMp1a.js").then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CRIHBpgC.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-wlgAducd.js"));
...
export {
  createReusableTemplate as A,
  useEventListener as B,
  Presence_default as C,
  useFieldGroup as D,
  useComponentIcons as E,
  _sfc_main$b as F,
  injectConfigProviderContext as G,
  useResizeObserver as H,
  resolveBaseURL as I,
  ImageComponent as J,
  createSharedComposable as K,
  useClipboard as L,
  getSlotChildrenText as M,
  Primitive as P,
  ...
  isNullish as l,
  useVModel as m,
  useForwardExpose as n,
  createContext as o,
  useForwardPropsEmits as p,
  get as q,
  reactivePick as r,
  transformUI as s,
  tv as t,
