import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { _ as _sfc_main$3 } from './Container-DlIMG7Wu.mjs';
import { defineComponent, withAsyncContext, withCtx, unref, createTextVNode, openBlock, createBlock, createVNode, toDisplayString, computed, toRaw, mergeProps, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderSlot } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/vue/server-renderer/index.mjs';
import { pascalCase, kebabCase } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/scule/dist/index.mjs';
import destr from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/destr/dist/index.mjs';
import { find, html } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/property-information/index.js';
import { f as flatUnwrap, n as nodeTextContent } from './node-CIB8iVlG.mjs';
import { toHast } from 'file:///home/yvan/Dev/web/work3/yvan/frontend/node_modules/minimark/dist/hast.mjs';
import { b as useRoute, c as useI18n, d as useAsyncData, e as _sfc_main$8, a as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: post } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(`post-${slug}-${locale.value}`, () => {
      return queryCollection("journal").path(`/journal/${locale.value}/${slug}`).first();
    }, {
      watch: [locale]
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(post)) {
              _push2(`<article${_scopeId}><header class="py-8"${_scopeId}><h1 class="text-4xl font-bold"${_scopeId}>${ssrInterpolate(unref(post).title)}</h1><p class="text-gray-500"${_scopeId}>${ssrInterpolate(unref(post).date)}</p></header>`);
              _push2(ssrRenderComponent(_component_ContentRenderer, { value: unref(post) }, null, _parent2, _scopeId));
              _push2(`</article>`);
            } else {
              _push2(`<div class="py-20 text-center"${_scopeId}><p${_scopeId}>L&#39;article &quot;${ssrInterpolate(unref(slug))}&quot; n&#39;existe pas en ${ssrInterpolate(unref(locale))}.</p>`);
              _push2(ssrRenderComponent(_component_UButton, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`Retour au journal`);
                  } else {
                    return [
                      createTextVNode("Retour au journal")
                    ];
                  }
                }),
                _: 1
            ...
            return [
              unref(post) ? (openBlock(), createBlock("article", { key: 0 }, [
                createVNode("header", { class: "py-8" }, [
                  createVNode("h1", { class: "text-4xl font-bold" }, toDisplayString(unref(post).title), 1),
                  createVNode("p", { class: "text-gray-500" }, toDisplayString(unref(post).date), 1)
                ]),
                ...
                createVNode("p", null, `L'article "` + toDisplayString(unref(slug)) + `" n'existe pas en ` + toDisplayString(unref(locale)) + ".", 1),
...
//# sourceMappingURL=_slug_-3ej0rbIa.mjs.map
